...
#include "../FACCTS2_2/userupdate.h"
...
static const char qt_meta_stringdata_userupdate[] = {
    "userupdate\0\0on_toolButton_addUser_clicked()\0"
};
...
void userupdate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_toolButton_addUser_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData userupdate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject userupdate::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_userupdate,
      qt_meta_data_userupdate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &userupdate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_userupdate))

...
namespace FACCTS.Server.Model.Membership
{
    public sealed class WebSecurity
    {
        ...
        public static MembershipCreateStatus Register(string Username, string Password, string Email, bool IsApproved, string FirstName, string LastName)
        {
            ...
            WS.Membership.CreateUser(Username, Password, Email, null, null, IsApproved, Guid.NewGuid(), out CreateStatus);
        ...
        public static Boolean Login(string Username, string Password, bool persistCookie = false)
        {
            ...
            bool success = WS.Membership.ValidateUser(Username, Password);
            if (success)
            {
        ...
        {
            return WS.Membership.GetUser(Username);
        }
        ...
        public static bool ChangePassword(string userName, string currentPassword, string newPassword)
        {
            ...
            try
            {
                MembershipUser currentUser = WS.Membership.GetUser(userName, true);
        ...
        {
            return WS.Membership.DeleteUser(Username);
        }

        public static int GetUserId(string userName)
        {
            MembershipUser user = WS.Membership.GetUser(userName);
        ...
        {
            CodeFirstMembershipProvider CodeFirstMembership = WS.Membership.Provider as CodeFirstMembershipProvider;
        ...
        {
            int totalRecords;
            return WS.Membership.FindUsersByEmail(Email, PageIndex, PageSize, out totalRecords).Cast<MembershipUser>().ToList();
        }

        public static List<MembershipUser> FindUsersByName(string Username, int PageIndex, int PageSize)
        {
            int totalRecords;
            return WS.Membership.FindUsersByName(Username, PageIndex, PageSize, out totalRecords).Cast<MembershipUser>().ToList();
        }

        public static List<MembershipUser> GetAllUsers(int PageIndex, int PageSize)
        {
            int totalRecords;
            return WS.Membership.GetAllUsers(PageIndex, PageSize, out totalRecords).Cast<MembershipUser>().ToList();
        }

...
namespace Faccts.Model.Entities
{
    ...
    public partial class LawEnforcement: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
    		...
    		public LawEnforcement()
    		{
    			...
    			Observable.Merge<Object>(
    				...
    				,this.ObservableForProperty(x => x.Agency)
    				,this.ObservableForProperty(x => x.Address)
    				,this.ObservableForProperty(x => x.CarposEntrySectionId)
    			).
    			Subscribe(_ =>
    			{
        ...
        [DataMember]
        public long CarposEntrySectionId
        {
            get { return _carposEntrySectionId; }
            set
            {
                if (_carposEntrySectionId != value)
                {
                    ChangeTracker.RecordOriginalValue("CarposEntrySectionId", _carposEntrySectionId);
    				OnPropertyChanging("CarposEntrySectionId");
                    _carposEntrySectionId = value;
                    OnPropertyChanged("CarposEntrySectionId");
                }
            }
        }
        private long _carposEntrySectionId;

...
namespace Faccts.Model.Entities
{
    ...
    public partial class ServiceFeesSection: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
        ...
        {
            get { return _basedOnViolence; }
            set
            {
                if (_basedOnViolence != value)
                {
    				OnPropertyChanging("BasedOnViolence");
                    _basedOnViolence = value;
                    OnPropertyChanged("BasedOnViolence");
                }
            }
        }
        private bool _basedOnViolence;
        ...
        public bool Waiver
        {
            ...
            set
            {
                if (_waiver != value)
                {
    				OnPropertyChanging("Waiver");
                    _waiver = value;
                    OnPropertyChanged("Waiver");
                }
            }
        }
        private bool _waiver;

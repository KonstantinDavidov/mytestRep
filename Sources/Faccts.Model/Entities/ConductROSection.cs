...
namespace Faccts.Model.Entities
{
    ...
    public partial class ConductROSection: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
    		
    		private MakeObjectReactiveHelper _reactiveHelper;
    
    		public ConductROSection()
    		{
    			...
    			Observable.Merge<Object>(
    				...
    				,this.ObservableForProperty(x => x.AppliedToOtherProtected)
    				,this.ObservableForProperty(x => x.OtherRequested)
    				,this.ObservableForProperty(x => x.OtherText)
    				,this.ObservableForProperty(x => x.OtherAttached)
    			).
    			Subscribe(_ =>
    			{

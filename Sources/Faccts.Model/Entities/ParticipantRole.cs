...
namespace Faccts.Model.Entities
{
    ...
    public partial class ParticipantRole: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
        ...
        {
            get { return _participantRoleName; }
            set
            {
                if (_participantRoleName != value)
                {
    				OnPropertyChanging("ParticipantRoleName");
                    _participantRoleName = value;
                    OnPropertyChanged("ParticipantRoleName");
                }
            }
        }
        private string _participantRoleName;
    	...
    	public override bool Equals(System.Object obj)
    	{
            ...
            ParticipantRole p = obj as ParticipantRole;
            if ((System.Object)p == null)
            {
    			...
    			if (this.Id != p.Id)
    				return false;
    			if (this.ParticipantRoleName != p.ParticipantRoleName)
    				return false;
    	...
    	public override int GetHashCode()
    	{
    		...
    		if (this.ParticipantRoleName != null)
    		{
    			hashCode ^= this.ParticipantRoleName.GetHashCode();
    		}
    		return hashCode;
    	}
        ...
        private void FixupCourtParty(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ParticipantRole, this))
                    {
                        item.ParticipantRole = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {

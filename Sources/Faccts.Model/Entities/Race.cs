...
namespace Faccts.Model.Entities
{
    ...
    public partial class Race: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
        ...
        public string RaceName
        {
            ...
            set
            {
                if (_raceName != value)
                {
    				OnPropertyChanging("RaceName");
                    _raceName = value;
                    OnPropertyChanged("RaceName");
                }
            }
        }
    	...
    	public override int GetHashCode()
    	{
    		...
    		hashCode ^= this.RaceName.GetHashCode();
        ...
        private void FixupCourtParty(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Race, this))
                    {
                        item.Race = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)

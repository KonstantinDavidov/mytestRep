...
namespace Faccts.Model.Entities
{
    ...
    public partial class CaseRecord: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> CourtCase_Id
        {
            ...
            set
            {
                if (!ReferenceEquals(_courtCase1, value))
                {
                    ...
                    if (_courtCase1 != null)
                    {
                        ...
                        foreach (CourtCase item in _courtCase1)
                        {
        ...
        [DataMember]
        public TrackableCollection<CourtCase> CourtCase2
        {
            get
            {
                if (_courtCase2 == null)
                {
                    _courtCase2 = new TrackableCollection<CourtCase>();
                    _courtCase2.CollectionChanged += FixupCourtCase2;
                }
                return _courtCase2;
            }
            set
            {
                if (!ReferenceEquals(_courtCase2, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    OnNavigationPropertyChanged("CourtCase2");
                }
            }
        }
        private TrackableCollection<CourtCase> _courtCase2;
        ...
        private void FixupCourtCase1(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CaseRecord1, this))
                    {
                        item.CaseRecord1 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
        ...
        private void FixupCourtCase2(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (CourtCase item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("CourtCase2", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CourtCase item in e.OldItems)
                {
                    if (item.CaseRecord2.Contains(this))
                    {
                        item.CaseRecord2.Remove(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("CourtCase2", item);
                    }
                }
            }
        }

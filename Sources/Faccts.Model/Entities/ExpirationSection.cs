...
namespace Faccts.Model.Entities
{
    ...
    public partial class ExpirationSection: IObjectWithChangeTracker, IReactiveNotifyPropertyChanged, INavigationPropertiesLoadable
    {
    		
    		private MakeObjectReactiveHelper _reactiveHelper;
    
    		public ExpirationSection()
    		{
    			...
    			Observable.Merge<Object>(
    				...
    				,this.ObservableForProperty(x => x.Expires)
    				,this.ObservableForProperty(x => x.DateTime)
    			).
    			Subscribe(_ =>
    			{

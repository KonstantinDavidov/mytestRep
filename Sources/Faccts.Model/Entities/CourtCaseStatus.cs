...
namespace Faccts.Model.Entities
{
    ...
    public partial class CourtCaseStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCourtCase(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CourtCaseStatus, this))
                    {
                        item.CourtCaseStatus = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {

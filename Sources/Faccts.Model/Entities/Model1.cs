...
namespace Faccts.Model.Entities
{
    ...
    public class TrackableCollection<T> : ObservableCollection<T>
    {
    	...
    	public interface INavigationPropertiesLoadable
        {
            event EventHandler<LoadingNavigationPropertiesEventArgs> OnNavigationPropertyLoading;
        }
    
    	public class LoadingNavigationPropertiesEventArgs : EventArgs
        {
            public LoadingNavigationPropertiesEventArgs(string propertyName) : base()
            {

...
namespace FACCTS.Server.Controllers
{
    ...
    //public class OAuth2AuthorizeController : Protocols.OAuth2.OAuth2AuthorizeController
    //{
    //    public OAuth2AuthorizeController(IConfigurationRepository configurationRepository, 
    //        IClientsRepository clientsRepository, IRelyingPartyRepository relyingPartyRepository) : base(configurationRepository, clientsRepository, relyingPartyRepository)
    //    {
